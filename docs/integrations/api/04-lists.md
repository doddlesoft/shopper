...
<!-- theme: warning -->
> Please note, when deleting a list, this will detach all items from the list as well as detach the list from any meals that have previously been added to it. Just another way we keep our data nice and clean.
